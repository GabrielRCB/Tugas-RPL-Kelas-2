...
Route::group(['middleware' => 'auth:user'], function (){
     Route::prefix('admin')->group(function (){
         ...
         Route::get('/admin/reset-password', [App\Http\Controllers\DashboartdController::class, 'resetPassword'])->name('dashboard.resetPassword');
         Route::post('/admin/reset-passsword',[App\Http\Controllers\DashboartdController::class, 'prosesResetPassword'])->name('dashboard.prosesResetPassword');
