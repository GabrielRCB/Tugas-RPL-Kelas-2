...
class UserController extends Controller
{
    ...
    public function prosesTambah(Request $request){
        ...
        try{
            $user->save();
            return redirect(route('user.index'))->with('pesan', ['success', 'Berasil tambah user']);
        }catch (\Exception $e){
    ...
    public function prosesUbah(Request $request){
        ...
        try{
            $user->save();
            return redirect(route('user.index'))->with('pesan', ['success', 'Berasil Ubah user']);
        }catch (\Exception $e){
    ...
    public  function hapus($id){
        ...
        try{
            $user->delete();
            return redirect(route('user.index'))->with('pesan', ['success', 'Berasil hapus user']);
        }catch (\Exception $e){
