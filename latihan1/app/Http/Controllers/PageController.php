...
class PageController extends Controller
{
    ...
    public function prosesTambah(Request $request){
        ...
        try{
            $page->save();
            return redirect(route('page.index'))->with('pesan', ['success', 'Berasil tambah page']);
        }catch (\Exception $e){
    ...
    public function prosesUbah(Request $request){
        ...
        try{
            $page->save();
            return redirect(route('page.index'))->with('pesan', ['success', 'Berasil Ubah page']);
        }catch (\Exception $e){
    ...
    public  function hapus($id){
        ...
        try{
            $page->delete();
            return redirect(route('page.index'))->with('pesan', ['success', 'Berasil hapus page']);
        }catch (\Exception $e){
