...
class KategoriController extends Controller
{
    ...
    public function prosesTambah(Request $request){
        ...
        try{
            $kategori->save();
            return redirect(route('kategori.index'))->with('pesan', ['success', 'Berasil tambah kategori']);
        }catch (\Exception $e){
    ...
    public function prosesUbah(Request $request){
        ...
        try{
            $kategori->save();
            return redirect(route('kategori.index'))->with('pesan', ['success', 'Berasil Ubah kategori']);
        }catch (\Exception $e){
